								...
								<div class="col-lg-6">
									<div class="p-5">
										<div class="text-center">
											<h1 class="h4 text-gray-900 mb-4">Update Data Mahasiswa!</h1>
										</div>
										<?php
										include 'koneksi.php';
										$nim = $_GET['id'];
										...
										?>
											<form class="user" action="updatemhs.php" method="post" enctype="multipart/form-data">
												<input type="hidden" name="nim" value="<?php echo $d['nim']; ?>">
												<div class="input-group">
													<label for="nim" class="col-form-label">NIM</label>
												</div>
												<div class="input-group mb-4">
													<input type="text" class="form-control" name="nim" id="nim" placeholder="NIM" value="<?php echo $d['nim']; ?>">
												</div>
												<div class="input-group">
													<label for="nama" class="col-form-label">Nama Mahasiswa</label>
												</div>
												<div class="input-group mb-4">
													<input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Mahasiswa" value="<?php echo $d['nama']; ?>">
												</div>
												<div class="input-group">
													<label for="semester" class="col-form-label">Semester</label>
												</div>
												<div class="input-group mb-4">
													<input type="text" class="form-control" name="semester" id="semester" placeholder="Semester" value="<?php echo $d['semester']; ?>">
												</div>
												<div class="input-group">
												...
												<div class="input-group mb-4">
													<input type="text" class="form-control" name="prodi" id="prodi" placeholder="Prodi" value="<?php echo $d['prodi']; ?>">
												</div>
												<div class="input-group">
												...
												<div class="row justify-content-between">
													<div class="col-md-4">
														<a href="tampilmhs.php" class="btn btn-danger btn-user btn-block">
															Batal
														</a>
													</div>
													<div class="col-md-4">
