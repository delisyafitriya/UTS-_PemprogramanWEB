							...
							<div class="row justify-content-center">
								<div class="col-lg-6">
									<div class="p-5">
										...
										<form class="user" action="inputuser_ruangan.php" method="post" enctype="multipart/form-data">
											...
											<div class="input-group mb-4">
												<input type="text" class="form-control" name="kapasitas" id="kapasitas" placeholder="Kapasitas" value="">
											</div>
											<div class="input-group">
