								...
								<div class="col-lg-6">
									<div class="p-5">
										<div class="text-center">
											<h1 class="h4 text-gray-900 mb-4">Tambah Data Asisten!</h1>
										</div>
										<form class="user" action="inputuser_asisten.php" method="post" enctype="multipart/form-data">
											<div class="input-group">
												<label for="id_asisten" class="col-form-label">ID Asisten</label>
											</div>
											<div class="input-group mb-4">
												<input type="text" class="form-control" name="id_asisten" id="id_asisten" placeholder="ID Asisten" value="">
											</div>
											<div class="input-group">
												<label for="nama" class="col-form-label">Nama Asisten</label>
											</div>
											<div class="input-group mb-4">
												<input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Asisten" value="">
											</div>
											<div class="input-group">
											...
											<div class="row justify-content-between">
												<div class="col-md-4">
													<a href="tampil_asisten.php" class="btn btn-danger btn-user btn-block">
														Batal
													</a>
												</div>
												<div class="col-md-4">
