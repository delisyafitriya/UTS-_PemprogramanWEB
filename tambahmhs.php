							...
							<div class="row justify-content-center">
								<div class="col-lg-6">
									<div class="p-5">
										...
										<form class="user" action="inputusermhs.php" method="post" enctype="multipart/form-data">
											<div class="input-group">
												<label for="nim" class="col-form-label">NIM</label>
											</div>
											<div class="input-group mb-4">
												<input type="text" class="form-control" name="nim" id="nim" placeholder="NIM" value="">
											</div>
											<div class="input-group">
												<label for="nama" class="col-form-label">Nama Mahasiswa</label>
											</div>
											<div class="input-group mb-4">
												<input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Mahasiswa" value="">
											</div>
											<div class="input-group">
												<label for="semester" class="col-form-label">Semester</label>
											</div>
											<div class="input-group mb-4">
												<input type="text" class="form-control" name="semester" id="semester" placeholder="Semester" value="">
											</div>
											<div class="input-group">
											...
											<div class="input-group mb-4">
												<input type="text" class="form-control" name="prodi" id="prodi" placeholder="Prodi" value="">
											</div>
											<div class="input-group">
											...
											<div class="input-group mb-4">
												<input type="text" class="form-control" name="telepon" id="telepon" placeholder="Telepon" value="">
											</div>
											<div class="input-group">
