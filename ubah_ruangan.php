								...
								<div class="col-lg-6">
									<div class="p-5">
										<div class="text-center">
											<h1 class="h4 text-gray-900 mb-4">Update Data Ruangan!</h1>
										</div>
										<?php
										include 'koneksi.php';
										$id_ruangan = $_GET['id'];
										...
										?>
											<form class="user" action="update_ruangan.php" method="post" enctype="multipart/form-data">
												...
												<div class="input-group mb-4">
													<input type="text" class="form-control" name="nama_ruangan" id="nama_ruangan" placeholder="Nama Ruangan" value="<?php echo $d['nama_ruangan']; ?>">
												</div>
												<div class="input-group">
													<label for="kapasitas" class="col-form-label">Kapasitas</label>
												</div>
												<div class="input-group mb-4">
													<input type="text" class="form-control" name="kapasitas" id="kapasitas" placeholder="Kapasitas" value="<?php echo $d['kapasitas']; ?>">
												</div>
												<div class="input-group">
													<label for="lokasi" class="col-form-label">Lokasi</label>
												</div>
												<div class="input-group mb-4">
													<input type="text" class="form-control" name="lokasi" id="lokasi" placeholder="Lokasi" value="<?php echo $d['lokasi']; ?>">
												</div>
												<div class="row justify-content-between">
													<div class="col-md-4">
														<a href="tampil_ruangan.php" class="btn btn-danger btn-user btn-block">
															Batal
														</a>
													</div>
													<div class="col-md-4">
