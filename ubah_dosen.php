								...
								<div class="col-lg-6">
									<div class="p-5">
										<div class="text-center">
											<h1 class="h4 text-gray-900 mb-4">Update Data Dosen!</h1>
										</div>
										<?php
										include 'koneksi.php';
										$nidn = $_GET['id'];
										...
										?>
											<form class="user" action="update_dosen.php" method="post" enctype="multipart/form-data">
												...
												<div class="input-group mb-4">
													<input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Dosen" value="<?php echo $d['nama']; ?>">
												</div>
												<div class="input-group">
												...
												<div class="input-group">
													<label for="pasword" class="col-form-label">Alamat</label>
												</div>
												<div class="input-group mb-4">
												...
												<div class="row justify-content-between">
													<div class="col-md-4">
														<a href="tampil_dosen.php" class="btn btn-danger btn-user btn-block">
															Batal
														</a>
													</div>
													<div class="col-md-4">
