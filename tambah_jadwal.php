								...
								<div class="col-lg-6">
									<div class="p-5">
										<div class="text-center">
											<h1 class="h4 text-gray-900 mb-4">Tambah Data Jadwal!</h1>
										</div>
										<form class="user" action="inputuser_jadwal.php" method="post" enctype="multipart/form-data">
											...
											<div class="input-group mb-4">
												<input type="text" class="form-control" name="mata_kuliah" id="mata_kuliah" placeholder="Mata Kuliah" value="">
											</div>
											<div class="input-group">
												<label for="hari" class="col-form-label">Hari</label>
											</div>
											<div class="input-group mb-4">
												<input type="text" class="form-control" name="hari" id="hari" placeholder="Hari" value="">
											</div>
											<div class="input-group">
												<label for="jam_mulai" class="col-form-label">Jam Mulai</label>
											</div>
											<div class="input-group mb-4">
												<input type="text" class="form-control" name="jam_mulai" id="jam_mulai" placeholder="Jam Mulai" value="">
											</div>
											<div class="input-group">
												<label for="jam_selesai" class="col-form-label">Jam Selesai</label>
											</div>
											<div class="input-group mb-4">
												<input type="text" class="form-control" name="jam_selesai" id="jam_selesai" placeholder="Jam Selesai" value="">
											</div>
											<div class="input-group">
												<label for="kelas" class="col-form-label">Kelas</label>
											</div>
											<div class="input-group mb-4">
												<input type="text" class="form-control" name="kelas" id="kelas" placeholder="Kelas" value="">
											</div>
											<div class="input-group">
												<label for="id_ruangan" class="col-form-label">ID Ruangan</label>
											</div>
											<div class="input-group mb-4">
												<input type="text" class="form-control" name="id_ruangan" id="id_ruangan" placeholder="ID Ruangan" value="">
											</div>
											<div class="input-group">
